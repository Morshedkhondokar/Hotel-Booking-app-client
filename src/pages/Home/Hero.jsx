        ...
        >
          ...
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full cursor-pointer px-4 py-2 rounded-lg text-black font-semibold mt-1 focus:outline-none border border-[#3d3d3d] focus:ring-2 focus:ring-[#D39F51]"
            />
          </div>
